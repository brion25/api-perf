...
function WriteReport(obj){
  ...
  obj.iterations.forEach(function(iteration){
    ...
    iteration.avgTimeRequest = concurrenceTimeTaken.reduce(function(val1, val2){ return val1 + val2 },0) / concurrenceTimeTaken.length;
  });
  obj.maxTimeRequest = Math.max.apply(this,iterationsTimeTaken);
  obj.minTimeRequest = Math.min.apply(this,iterationsTimeTaken);
  obj.avgTimeRequest = iterationsTimeTaken.reduce(function(val1, val2){ return val1 + val2 },0) / iterationsTimeTaken.length;
